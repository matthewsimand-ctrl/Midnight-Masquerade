...
export function MotifReveal() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-8 relative overflow-hidden">
      ...
      <div className="mt-4 sm:mt-12 text-center max-w-4xl w-full z-10">
        <h2 className="text-xl sm:text-2xl text-[var(--color-gold)] font-serif mb-4 sm:mb-8 uppercase tracking-widest">Round {gameState.round} Begins</h2>
        
        <div className="w-full min-h-[120px] bg-gradient-to-r from-[var(--color-velvet)] via-[var(--color-charcoal-rich)] to-[var(--color-velvet)] border-y border-[var(--color-gold)]/30 relative flex items-center px-4 sm:px-8 py-4 animate-bloom overflow-hidden shadow-[0_0_40px_rgba(212,175,55,0.15)]">
          ...
          <div className="flex items-center gap-3 sm:gap-8 w-full relative z-10">
             {/* Player Avatar */}
            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full flex-shrink-0 flex items-center justify-center shadow-inner border border-black/50 bg-[var(--color-burgundy)] overflow-hidden text-2xl">
            ...
            <div className="flex-1 text-left">
              ...
              <h1 className="text-lg sm:text-2xl md:text-3xl font-serif text-[var(--color-gold)] font-bold mb-1 break-words">
      ...
      {isHost && (
        <button
          ...
          className="mt-10 sm:mt-16 px-6 sm:px-8 py-3 sm:py-4 rounded bg-gradient-to-br from-[var(--color-gold)] to-[var(--color-gold-light)] text-[var(--color-midnight)] font-serif font-bold uppercase tracking-widest shadow-[0_0_24px_rgba(212,175,55,0.35)] hover:scale-105 transition-transform z-10"
        >
