...
const HOW_TO_PLAY_SECTIONS: Array<{ title: string; body: string[] }> = [
  ...
  },
  {
    ...
    body: [
      ...
      "Phase 5: The Voting Phase — Players cast a vote for who should be eliminated. Lions should try to vote out a Serpent and Serpents should try to vote out a Lion. The player with the most votes is eliminated and their alliance is revealed along with both motifs.",
